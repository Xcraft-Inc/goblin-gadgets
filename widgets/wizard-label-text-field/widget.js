...
class WizardLabelTextField extends Form {
  constructor () {
    super (...arguments);
    this.scale = 3;
    ...
    if (this.showFrame) {
      ...
      return (
        <div className={frameClass}>
          <LabelTextField key={index} model=".x" list={list} {...props} />
        </div>
      );
    } else {
      return <LabelTextField key={index} model=".x" list={list} {...props} />;
    }
  }
...
export default WizardLabelTextField;
